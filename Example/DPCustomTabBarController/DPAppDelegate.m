...
//
//  Created by Kostas Antonopoulos on 08/08/2016.
//  Copyright (c) 2016 Kostas Antonopoulos. All rights reserved.
//

#import "DPAppDelegate.h"
#import "DPFirstViewController.h"
#import "DPSecondViewController.h"
#import <DPCustomTabBarController/DPCustomTabBarController.h>

@interface DPAppDelegate ()<DPCustomTabBarControllerDelegate>
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    DPFirstViewController *firstVC=[[DPFirstViewController alloc]init];
    DPSecondViewController *secondVC=[[DPSecondViewController alloc]init];
...
-(UIButton*)customTabBarController:(DPCustomTabBarController *)customTabBarContr buttonAtIndex:(NSInteger)index{
    ...
    [btn setTitle:[NSString stringWithFormat:@"%d",(int)index] forState:UIControlStateNormal];
    [btn setTitle:[NSString stringWithFormat:@"S%d",(int)index] forState:UIControlStateHighlighted];
